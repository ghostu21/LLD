...
/**
 * Demo: salt+hash passwords, login tokens, reject bad password, logout revoke.
 * <p>
 * Interview angle: plaintext passwords are an instant reject; show token expiry path.
 */
public class AuthScenario implements FeatureScenario {
    /**
     * Registers Alice/Bob → successful login → validate → failed login → logout.
     */
    @Override
