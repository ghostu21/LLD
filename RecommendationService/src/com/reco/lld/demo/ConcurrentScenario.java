...
/**
 * Concurrent recommend calls share ConcurrentHashMap stores without tearing.
 */
public class ConcurrentScenario implements FeatureScenario {
    ...
    public void run(DemoFixtures fx) throws Exception {
        ...
        pool.shutdownNow();
        System.out.println("16 parallel HOME calls returned " + total + " items (sum of slate sizes)");
    }
}
