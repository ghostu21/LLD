 ...
 * <p>
 * Why: rankers should depend on affinities and blocked ids — not email,
 * username, or another person's identity. This is the privacy boundary.
 */
public final class UserProfile {
    ...
    /** Cold start: not enough positive history for collaborative ranking. */
    public boolean isColdStart() {
        return positiveSignalCount < 2;
    }
}
